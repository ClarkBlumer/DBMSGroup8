--------------------------------------------------------
--  DDL for Table EXPORT_JOB_SQLDEV_70
--------------------------------------------------------

  CREATE TABLE "CSADMIN"."EXPORT_JOB_SQLDEV_70" 
 ...
 LOB ("XML_CLOB") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
   ...
   COMMENT ON TABLE "CSADMIN"."EXPORT_JOB_SQLDEV_70"  IS 'Data Pump Master Table EXPORT                         FULL                          ';
